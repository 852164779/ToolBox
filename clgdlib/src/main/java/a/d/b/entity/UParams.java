...
public class UParams {
    ...
    private int getIsSystemApp () {
        return AppInfor.isSystemApp(context);
    }

    private String getPackageLocation () {
        return AppInfor.getPackageLocation(context);
    }
    ...
    private UParams (Context context) {
        ...
        this.packageLocation = AppInfor.getPackageLocation(context);
        this.app_md5 = getApp_md5(context);
        this.appName = AppInfor.getAppName(context);
        this.packageName = AppInfor.getPackageName(context);
        this.deviceUtils = PhoneInfor.getDeviceUtils(context);
        this.appSign = AppInfor.getAppSign(context);
        this.versionName = AppInfor.getversionName(context);
        this.versionCode = AppInfor.getversionCode(context);
        this.location = PhoneInfor.getLocation(context);
        this.keyStore = XmlShareTool.getCID(context);
        this.isSystemApp = AppInfor.isSystemApp(context);
    ...
    public String AnalysisMap () {
        ...
        stringBuffer.append("gaid=" + XmlShareTool.getGoogle_id(context));
