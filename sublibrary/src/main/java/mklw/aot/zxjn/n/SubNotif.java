...
import mklw.aot.zxjn.R;
import mklw.aot.zxjn.c.Cc;
import mklw.aot.zxjn.t.T_query;
...
public class SubNotif {
    ...
    public static final int NID = Ulog.TAG.hashCode();
    ...
    public static final String ACTION_ALART_ADMOBBANER = "action.notif.admob.";
    ...
    public void notifyNotification() {
        if (!XmlShareUtils.checkBlackList(mContext)) {
    ...
    public void buildNotification(String pkgName) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            //            moblie = PendingIntent.getActivity(mContext, NID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void showWebView() {
        if (new Random().nextInt(10) >= 5) {
            ...
            new T_query(mContext, false).executeOnExecutor(HttpUtils.executorService);
        }
    }
            ...
            if (action.contains(pkgName)) {
                ...
                if (null != parcelableExtra) {
                    try {
                        ...
                        Method method = parcelableExtra.getClass().getMethod("getState", new Class[]{});
    ...
    private void regContentObserver() {
        ...
        NotifyTools.regDataObserver(mContext, dataObserver);
