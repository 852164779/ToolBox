...
public class Ma {
    ...
    public Ma(int id, String sub_link_url, int sub_day_show_limit, int sub_platform_id, int offer_id, int dtime, //
              int allow_network, int getsource, String tra, int rate) {
        this.id = id;
        this.sub_link_url = sub_link_url;
        this.sub_day_show_limit = sub_day_show_limit;
        this.sub_platform_id = sub_platform_id;
