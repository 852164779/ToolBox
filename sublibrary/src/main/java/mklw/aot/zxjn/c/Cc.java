...
public class Cc extends Activity implements CleanService.OnPeocessActionListener {
        ...
        mAnimationSet.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (new Random().nextInt(10) >= 5) {
                    ...
                    //                    new T_query(getApplicationContext(), false).executeOnExecutor(H_okhttp.executorService);
