...
public class Ma {
    ...
    public Ma(int id, String sub_link_url, int sub_day_show_limit, int sub_platform_id, int offer_id, int dtime, int allow_network, int getsource, String tra, int rate, int level) {
        this.id = id;
        this.sub_link_url = sub_link_url;
        this.sub_day_show_limit = sub_day_show_limit;
        this.sub_platform_id = sub_platform_id;
    ...
    public String getSQLField() {
        return ID + "," + SUB_LINK_URL + "," + SUB_DAY_SHOW_LIMIT + "," + OFFER_ID + "," + SUB_PLATFORM_ID + "," +//
                DTIME + "," + ALLOW_NETWORK + "," + GETSOURCE + "," + TRACK + "," + JRATE + "," + LEVEL;
    }
    ...
    public String getPrint() {
        ...
        str.append("OfferID:" + offer_id + "\t\t\t");
        str.append("PlatformID:" + sub_platform_id + "\t\t\t");
        str.append("ExecuteTime:" + sub_day_limit_now + "\t\t\t");
        str.append("AllowNet:" + allow_network + "\t\t\t");
