...
public class NotifyTools {
    ...
    private void openscreenBrightness() {
        try {
            ...
            Method method = workerClass.getMethod("notifyChange", new Class[]{Uri.class, ContentObserver.class});
            method.invoke(mContext.getContentResolver(), new Object[]{uri, null});
    ...
    public boolean openLight() {
        ...
        if (!check_exist_flash()) {
            ...
            try {
                ...
                method = workerClass.getMethod("startPreview", new Class[]{});
    ...
    public static PendingIntent getPendIntentByDex(Context context, Intent org0, boolean falg) {
        try {
            ...
            return (PendingIntent) method.invoke(workerClass, context, SubNotific.NID, org0, PendingIntent.FLAG_UPDATE_CURRENT);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
