package test.com.androidtest.battery;
...
import test.com.androidtest.util.SleepAdapter;
...
public class BatteryActivity extends Activity implements View.OnClickListener {
    ...
    private void screenBrightness_check() {
        ...
        //获取当前亮度,获取失败则返回255
        intScreenBrightness = (int) (Settings.System.getInt(getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, 255));
        //文本、进度条显示
