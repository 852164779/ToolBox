package test.com.androidtest.calculator.history;
...
import test.com.androidtest.calculator.utils.ParseExpression;
...
public class CalLayout extends GridLayout implements OnClickListener {
    ...
    private String[] btTexts = new String[]{"C", "÷", "×", "D", "7", "8", "9", "-", "4", "5", "6", "+", "1", "2", "3", parenthesis, "0", ".", "%", "="};
    ...
    public CalLayout(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.calculator_custom_layout, this);
    ...
    private void initCalUI() {
        ...
        gridLayout.setBackgroundColor(getResources().getColor(R.color.calculator_back));
        //批量初始化按钮
