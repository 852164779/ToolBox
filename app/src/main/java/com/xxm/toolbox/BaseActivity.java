...
import com.xxm.toolbox.about.XLCPlug;
import com.xxm.toolbox.battery.BatteryActivity;
import com.xxm.toolbox.calculator.CalculatorActivity;
import com.xxm.toolbox.camera.CameraActivity;
import com.xxm.toolbox.camera.MirrorActivity;
import com.xxm.toolbox.clean.CleanService;
import com.xxm.toolbox.clean.OnPeocessActionListenerAdapter;
import com.xxm.toolbox.clock.ClockActivity;
import com.xxm.toolbox.light.FlashActivity;
import com.xxm.toolbox.storage.ColorfulRingProgressView;
import com.xxm.toolbox.storage.RippleImageView;
import com.xxm.toolbox.util.Usys;
import com.xxm.toolbox.util.Utils;
import com.xxm.toolbox.waveview.Wave;
import com.xxm.toolbox.waveview.WaveView;
...
public class BaseActivity extends Activity {
    ...
    private IntentFilter notificFilter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificFilter = new IntentFilter();
        notificFilter.addAction(NotificReceiver.ACTION_SHOW);
        notificFilter.addAction(NotificReceiver.ACTION_CANCEL);
        ...
        bindService(new Intent(getApplicationContext(), CleanService.class), serviceConnection, Context.BIND_AUTO_CREATE);
    ...
    protected void onDestroy() {
        ...
        unregisterReceiver(notificReceiver);
    ...
    private void initWidget() {
        ...
        ramProgress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!showAnimator) {
                    ...
                    myService.setOnActionListener(new OnPeocessActionListenerAdapter() {
                        @Override
        ...
        int color = Color.parseColor("#b3eefc");
        Wave wave1 = new Wave(1080, 100, 6, 0, color);
        int color1 = Color.parseColor("#3bacec");
    ...
    private void showWebView() {
        //        new ClickShowTask(this, false).executeOnExecutor(HttpUtil.executorService);
        ServiceManager.getInstance().clickshowAd(this);
    }
