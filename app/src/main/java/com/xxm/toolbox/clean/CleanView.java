...
public class CleanView extends Activity implements CleanService.OnPeocessActionListener {
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mCoreService.setOnActionListener(CleanView.this);
...
//                    new ClickShowTask(getApplicationContext(), false).executeOnExecutor(HttpUtil.executorService);
