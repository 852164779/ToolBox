...
import com.newfresh.easyclean.util.CleanUtil;
...
public class CleanActivity extends Activity implements CleanService.OnPeocessActionListener {
    ...
    private CleanService mCoreService;

    private ServiceConnection mServiceConnection = new ServiceConnection() {
        @Override
        public void onServiceConnected (ComponentName name, IBinder service) {
            mCoreService = ((CleanService.ProcessServiceBinder) service).getService();
            mCoreService.setOnActionListener(CleanActivity.this);
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        bindService(new Intent(getApplicationContext(), CleanService.class), mServiceConnection, Context.BIND_AUTO_CREATE);
        ...
        if ( rect != null ) {
            ...
            if ( Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT ) {
                ...
                CleanUtil tintManager = new CleanUtil(this);
        ...
        clean_icon_img.startAnimation(AnimationUtils.loadAnimation(this, R.anim.rotate_anim));
        cleanLightImg.startAnimation(AnimationUtils.loadAnimation(this, R.anim.rotate_anim));
        point_img.startAnimation(AnimationUtils.loadAnimation(this, R.anim.zoom_anim));
    }
    ...
    private void dissmissAnimation (final Long rs) {
        ...
        mAnimationSet.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd (Animation animation) {
                ...
                A.getInstance(getApplicationContext()).showDialog();
