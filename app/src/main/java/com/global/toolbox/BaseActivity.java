        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1011) {
                ...
                if (showStartAnimator) {
                    ...
                    handler.sendEmptyMessageDelayed(2020, 500);
                }
    ...
    public void baseOnClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.mirror:
                ...
                break;
            case R.id.about_Lay:
                startActivity(new Intent(BaseActivity.this, ArrkiiAppWall.class));
                break;
        }
        if (random.nextInt(10) >= 7 && view.getId() != R.id.about_Lay) {
            showWebView();
        }
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
    }
